...
var style_Gold_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 12.0 + size, points: 5,
            radius2: 6.0, stroke: new ol.style.Stroke({color: 'rgba(255,81,1,0.749019607843)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(255,221,1,1.0)'})}),
